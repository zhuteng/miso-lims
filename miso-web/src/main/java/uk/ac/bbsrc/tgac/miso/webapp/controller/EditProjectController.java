...
public class EditProjectController {
    ...
    public Map<Long, Collection<Library>> populateLibraryGroupMap(Project project, Collection<Library> projectLibraries)
        throws IOException {
    ...
    public String processSubmit(@ModelAttribute("project") Project project, ModelMap model, SessionStatus session,
