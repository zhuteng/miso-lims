...
public class ExternalRestController {
    ...
    @ResponseBody
    public String jsonRest() throws IOException {
    ...
    @ResponseBody
    public String jsonRestProject(@PathVariable Long projectId, ModelMap model) throws IOException {
        StringBuilder sb = new StringBuilder();
            ...
            for (Run run : runs) {
                ...
                if (!run.getStatus().getHealth().getKey().equals("Failed")) {
                    ...
                    sb.append("'status':'" +
                              ...
                              "'");
                    sb.append(",");
                    sb.append("'startDate':'" + (run.getStatus() != null && run.getStatus().getStartDate() != null ?
