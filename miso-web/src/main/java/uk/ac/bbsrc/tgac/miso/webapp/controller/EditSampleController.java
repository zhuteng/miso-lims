...
public class EditSampleController {
    ...
    public Boolean isMetrixEnabled() {
        MisoPropertyExporter exporter = (MisoPropertyExporter) applicationContextProvider.getApplicationContext()
    ...
    public Map<String, Sample> getAdjacentSamplesInGroup(Sample s,
                                                         @RequestParam(value = "entityGroupId", required = true) Long entityGroupId)
        throws IOException {
