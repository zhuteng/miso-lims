            ...
            try {
                ...
                if (!barcodeCollision) {
                    ...
                    for (Dilution dl : (Collection<? extends Dilution>) pool.getDilutions()) {
                        sb.append("<li>" + dl.getName() + " (<a href='/miso/library/" + dl.getLibrary().getId() + "'>" +
                                  dl.getLibrary().getAlias() + "</a>)</li>");
                    }
                    sb.append("</ul>");
            ...
            for (Dilution dl : dls) {
                if (dl.getLibrary().getQcPassed() != null) {
                    if (dl.getLibrary().getQcPassed()) {
                        ...
                        a.add(JSONObject.fromObject(
                            "{'id':" + dl.getId() + ",'name':'" + dl.getName() + "','description':'" + dl.getLibrary().getDescription() +
