...
public class ImportExportControllerHelperService {
            ...
            if (samples.size() > 0) {
                ...
                for (Sample s : samples) {
                    ...
                    b.append("<div id=\"sample" + s.getId() +
                             ...
                             " " + "class=\"dashboard\">");
                    b.append("<input type=\"hidden\" id=\"" + s.getId() + "\" name=\"" + s.getName() + "\" projectname=\"" +
                             s.getProject().getName() + "\" projectalias=\"" + s.getProject().getAlias() + "\" samplealias=\"" +
                             s.getAlias() + "\" dnaOrRNA=\"" + dnaOrRNA + "\"/>");
    ...
    public JSONObject exportSampleForm(HttpSession session, JSONObject json) {
        try {
            ...
            File f = misoFileManager.getNewFile(Sample.class, "forms", "SampleExportForm-" + LimsUtils
                .getCurrentDateAsString(new SimpleDateFormat("yyyyMMdd-hhmmss")) + ".xlsx");
    ...
    public JSONObject generateCSVBAC(HttpSession session, JSONObject json) {
        try {
            JSONArray a = JSONArray.fromObject(json.getString("form"));
            File f = misoFileManager.getNewFile(Plate.class, "csv", "Illumina-Nextera-6x-384-barcode-" + LimsUtils
                .getCurrentDateAsString(new SimpleDateFormat("yyyyMMdd-hhmmss")) + ".csv");
    ...
    public JSONObject exportLibraryPoolForm(HttpSession session, JSONObject json) {
        try {
            ...
            JSONArray a = JSONArray.fromObject(json.getString("form"));
            File f = misoFileManager.getNewFile(Library.class, "forms", "LibraryPoolExportForm-" + LimsUtils
                .getCurrentDateAsString(new SimpleDateFormat("yyyyMMdd-hhmmss")) + ".xlsx");
                        ...
                        if ("A".equals(proceedKey) || "L".equals(proceedKey) || "U".equals(proceedKey)) {
                            ...
                            try {
                                ...
                                if (m.matches()) {
                                    ...
                                    throw new InputFormException(
                                        "Supplied Library insert size for library '" + jsonArrayElement.getString(3) + "' (" +
                                        s.getAlias() + ") is invalid");
                                }
                            } catch (NumberFormatException nfe) {
                                throw new InputFormException(
                                    "Supplied Library insert size for library '" + jsonArrayElement.getString(3) + "' (" + s.getAlias() +
                                    ") is invalid", nfe);
                            }
                            ...
                            if (jsonArrayElement.getString(5) != null && !"".equals(jsonArrayElement.getString(5))) {
                                try {
                                    ...
                                    throw new InputFormException(
                                        "Supplied Library QC concentration for library '" + jsonArrayElement.getString(3) + "' (" +
                            ...
                            if (jsonArrayElement.getString(9) != null && !"".equals(jsonArrayElement.getString(9)) &&
                                ...
                                if (!bcs.isEmpty()) {
                                    ...
                                    throw new InputFormException(
                                        "No tag barcodes associated with the kit definition '" + jsonArrayElement.getString(9) +
                        ...
                        if ((library.getQcPassed() || library.getQcPassed() == null) &&
                            ...
                            if (jsonArrayElement.getString(11) != null && !"".equals(jsonArrayElement.getString(11))) {
                                try {
                                    ...
                                    throw new InputFormException(
                                        "Supplied LibraryDilution concentration for library '" + jsonArrayElement.getString(3) + "' (" +
                                        s.getAlias() + ") is invalid", nfe);
                                }
                            }
