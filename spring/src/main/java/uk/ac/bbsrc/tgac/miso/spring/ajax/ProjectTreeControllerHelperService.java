            ...
            for (Run run : runs) {
                if (run.getStatus() != null && run.getStatus().getHealth() != null &&
                    ...
                    runsArray.add(JSONObject.fromObject(
                        "{'name': '" + run.getName() + "','description':'" + run.getAlias() + "','show':'\"RUN \"','color': '1'}"));
                } else {
                    runsArray.add(JSONObject.fromObject(
                        "{'name': '" + run.getName() + "','description':'" + run.getAlias() + "','show':'\"RUN \"','color': '0'}"));
                }
            ...
            for (Sample sample : samples) {
                ...
                if (libraries.size() == 0) {
                    ...
                    samplesArray.add(JSONObject.fromObject(
                        "{'name': '" + sample.getName() + "','description':'" + sample.getAlias() + "','subs':'\"0\"','color': '" +
                        sampleQC + "'}"));
                } else {
