...
public class ExperimentWizardControllerHelperService {
    ...
    public JSONObject addExperimentForm(HttpSession session, JSONObject json) {
        ...
        String html = "            <div id=\"new" + (newId + 1) +
                      "\"><a href=\"#\" class=\"add\" onclick=\"Experiment.ui.addExperimentForm(" + (newId + 1) +
                      ");\">Add a new experiment</a>\n" +
                      "                   </div><br/>" +
                      ...
                      "\"/>" +
                      "<span onclick=\"Experiment.ui.confirmRemoveExperiment(" + newId +
                      ");\" class=\"float-right ui-icon ui-icon-circle-close\" style=\"cursor:pointer;\"></span>\n" +
                      "                </td></tr>\n" +
                      "                <tr>\n" +
                      "                    <td class=\"h\">Alias:</td>\n" +
                      "                    <td><input type=\"text\" id=\"alias" + newId + "\" class=\"needcheck\" name=\"alias" + newId +
                      "\"/></td>\n" +
                      "                </tr>\n" +
                      "                <tr>\n" +
                      "                    <td class=\"h\">Description:</td>\n" +
                      "                    <td><input type=\"text\" id=\"description" + newId +
                      "\" class=\"needcheck\" name=\"description" + newId + "\"/></td>\n" +
                      "                </tr>\n" +
                      "                <tr>\n" +
                      "                    <td>Platform:</td>\n" +
                      "                    <td><select name=\"platform" + newId +
                      "\" onchange=\"Experiment.pool.loadPoolsByPlatform(this, " + newId + ");\">\n" +
                      populatePlatform() +
                      "                    </select>\n" +
                      "                    </td>\n" +
                      "                </tr>\n" +
            ...
            if (json.has("platformId") && !"".equals(json.getString("platformId"))) {
                ...
                if (platform != null) {
                    ...
                    List<Pool<? extends Poolable>> pools = new ArrayList<Pool<? extends Poolable>>(
                        requestManager.listAllPoolsByPlatform(pt));
