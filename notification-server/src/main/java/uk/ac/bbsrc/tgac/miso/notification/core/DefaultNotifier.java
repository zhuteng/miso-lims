            ...
            for (String platformType : PlatformType.getKeys()) {
                ...
                if (props.containsKey(platformType + ".dataPaths")) {
                    ...
                    if (props.containsKey(platformType + ".scanRate")) {
                        trigger = new DynamicTrigger(Integer.parseInt(props.getProperty(platformType + ".scanRate")),
                    ...
                    log.warn(
                        "You have not specified a list of " + platformType + " paths to scan. Please add a " + platformType.toLowerCase() +
