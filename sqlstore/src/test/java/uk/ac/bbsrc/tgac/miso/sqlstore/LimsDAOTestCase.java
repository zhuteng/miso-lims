...
public abstract class LimsDAOTestCase extends DatabaseTestCase {
    ...
    private static final String[] tables = { "Alert", "EntityGroup", "EntityGroup_Elements", "Experiment", "Experiment_Kit", "Kit",
                                             "KitDescriptor", "Kit_Note", "Library", "LibraryDilution", "LibraryQC", "LibrarySelectionType",
                                             "LibraryStrategyType", "LibraryType", "Library_Note", "Library_TagBarcode", "Note",
                                             "_Partition", "Plate", "Plate_Elements", "Platform", "Pool", "PoolQC", "Pool_Elements",
                                             "Pool_Experiment", "PrintJob", "PrintService", "Project", "ProjectOverview",
                                             "ProjectOverview_Note", "Project_Issues", "Project_Note", "Project_ProjectOverview",
                                             "Project_Request", "Project_Study", "QCType", "Request", "Request_Note", "Run", "RunQC",
                                             "RunQC_Partition", "Run_Note", "Sample", "SampleQC", "SampleType", "Sample_Note",
                                             "SecurityProfile", "SecurityProfile_ReadGroup", "SecurityProfile_ReadUser",
                                             "SecurityProfile_WriteGroup", "SecurityProfile_WriteUser", "SequencerPartitionContainer",
                                             "SequencerPartitionContainer_Partition", "SequencerReference", "Status", "Study", "StudyType",
                                             "Study_Experiment", "Submission", "Submission_Experiment", "Submission_Partition_Dilution",
                                             "Submission_Sample", "Submission_Study", "TagBarcodes", "User", "User_Group", "Watcher",
                                             "_Group", "emPCR", "emPCRDilution", };
    ...
    private static void createDatabase(Connection conn) throws Exception {
        ...
        runStatement(conn, "CREATE TABLE Alert (" +
        ...
        runStatement(conn, "CREATE TABLE EntityGroup (" +
        ...
        runStatement(conn, "CREATE TABLE EntityGroup_Elements (" +
        ...
        runStatement(conn, "CREATE TABLE Experiment (" +
        ...
        runStatement(conn, "CREATE TABLE Experiment_Kit (" +
                           "experiments_experimentId BIGINT NOT NULL," +
                           "kits_kitId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Kit (" +
        ...
        runStatement(conn, "CREATE TABLE KitDescriptor (" +
                           "kitDescriptorId BIGINT NOT NULL," +
        ...
        runStatement(conn, "CREATE TABLE Kit_Note (" +
                           "kit_kitId BIGINT NOT NULL," +
                           "notes_noteId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Library (" +
        ...
        runStatement(conn, "CREATE TABLE LibraryDilution (" +
        ...
        runStatement(conn, "CREATE TABLE LibraryQC (" +
        ...
        runStatement(conn, "CREATE TABLE LibraryType (" +
        ...
        runStatement(conn, "CREATE TABLE LibrarySelectionType (" +
        ...
        runStatement(conn, "CREATE TABLE LibraryStrategyType (" +
        ...
        runStatement(conn, "CREATE TABLE Library_Note (" +
                           "library_libraryId BIGINT NOT NULL," +
                           "notes_noteId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Library_TagBarcode (" +
                           "library_libraryId BIGINT NOT NULL," +
                           "barcode_barcodeId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Note (" +
        ...
        runStatement(conn, "CREATE TABLE _Partition (" +
        ...
        runStatement(conn, "CREATE TABLE Plate (" +
        ...
        runStatement(conn, "CREATE TABLE Plate_Elements (" +
        ...
        runStatement(conn, "CREATE TABLE Pool (" +
        ...
        runStatement(conn, "CREATE TABLE PoolQC (" +
                           "qcId BIGINT NOT NULL," +
        ...
        runStatement(conn, "CREATE TABLE Pool_Experiment (" +
                           "pool_poolId BIGINT NOT NULL," +
                           "experiments_experimentId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Pool_Elements (" +
                           "pool_poolId BIGINT NOT NULL," +
                           "elementType VARCHAR(255) NOT NULL" +
                           "elementId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Platform (" +
        ...
        runStatement(conn, "CREATE TABLE PrintJob (" +
        ...
        runStatement(conn, "CREATE TABLE PrintService (" +
        ...
        runStatement(conn, "CREATE TABLE Project (" +
        ...
        runStatement(conn, "CREATE TABLE Project_Issues (" +
                           "project_projectId BIGINT NOT NULL," +
                           "issueKey VARCHAR NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE ProjectOverview (" +
        ...
        runStatement(conn, "CREATE TABLE ProjectOverview_Note (" +
                           "overview_overviewId BIGINT NOT NULL," +
                           "notes_noteId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Project_Note (" +
                           "project_projectId BIGINT NOT NULL," +
                           "notes_noteId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Project_ProjectOverview (" +
                           "project_projectID BIGINT NOT NULL," +
                           "overviews_overviewId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Project_Request (" +
                           "Project_projectId BIGINT NOT NULL," +
                           "requests_requestId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Project_Study (" +
                           "Project_projectId BIGINT NOT NULL," +
                           "studies_studyId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE QcType (" +
        ...
        runStatement(conn, "CREATE TABLE Request (" +
        ...
        runStatement(conn, "CREATE TABLE Request_Note (" +
                           "Request_requestId BIGINT NOT NULL," +
                           "notes_noteId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Run (" +
        ...
        runStatement(conn, "CREATE TABLE RunQC (" +
                           "qcId BIGINT NOT NULL," +
        ...
        runStatement(conn, "CREATE TABLE RunQC_Partition (" +
                           "runQc_runQcId BIGINT NOT NULL," +
                           "containers_containerId BIGINT NOT NULL," +
                           "partitionNumber TINYINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Run_SequencerPartitionContainer (" +
                           "Run_runId BIGINT NOT NULL," +
                           "containers_containerId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Run_Note (" +
                           "run_runId BIGINT NOT NULL," +
                           "notes_noteId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Sample (" +
        ...
        runStatement(conn, "CREATE TABLE SampleQC (" +
                           "qcId BIGINT NOT NULL," +
                           "sample_sampleId BIGINT NOT NULL," +
                           "qcUserName VARCHAR(255) NOT NULL," +
                           "qcDate TIMESTAMP NOT NULL," +
        ...
        runStatement(conn, "CREATE TABLE SampleType (" +
                           "typeId BIGINT NOT NULL," +
                           "name VARCHAR(255) NOT NULL," +
                           "PRIMARY KEY (typeId)" +
                           ");");

        runStatement(conn, "CREATE TABLE Sample_Note (" +
                           "sample_sampleId BIGINT NOT NULL," +
                           "notes_noteId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE SecurityProfile (" +
        ...
        runStatement(conn, "CREATE TABLE SecurityProfile_ReadGroup (" +
                           "SecurityProfile_profileId BIGINT NOT NULL," +
                           "readGroup_groupId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE SecurityProfile_ReadUser (" +
                           "SecurityProfile_profileId BIGINT NOT NULL," +
                           "readUser_userId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE SecurityProfile_WriteGroup (" +
                           "SecurityProfile_profileId BIGINT NOT NULL," +
                           "writeGroup_groupId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE SecurityProfile_WriteUser (" +
                           "SecurityProfile_profileId BIGINT NOT NULL," +
                           "writeUser_userId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE SequencerPartitionContainer (" +
        ...
        runStatement(conn, "CREATE TABLE SequencerPartitionContainer_Partition (" +
                           "container_containerId BIGINT NOT NULL," +
                           "partitions_partitionId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE SequencerReference (" +
        ...
        runStatement(conn, "CREATE TABLE Status (" +
        ...
        runStatement(conn, "CREATE TABLE Study (" +
        ...
        runStatement(conn, "CREATE TABLE StudyType (" +
                           "typeId BIGINT NOT NULL," +
                           "name VARCHAR(255) NOT NULL," +
                           "PRIMARY KEY (typeId)" +
                           ");");

        runStatement(conn, "CREATE TABLE Study_Experiment (" +
                           "Study_studyId BIGINT NOT NULL," +
                           "experiments_experimentId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Submission (" +
        ...
        runStatement(conn, "CREATE TABLE Submission_Experiment (" +
                           "submission_submissionId BIGINT NOT NULL," +
                           "experiments_experimentId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Submission_Partition_Dilution (" +
                           "submission_submissionId BIGINT NOT NULL," +
        ...
        runStatement(conn, "CREATE TABLE Submission_Sample (" +
                           "submission_submissionId BIGINT NOT NULL," +
                           "samples_sampleId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE Submission_Study (" +
                           "submission_submissionId BIGINT NOT NULL," +
                           "studies_studyId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE TagBarcodes (" +
        ...
        runStatement(conn, "CREATE TABLE User (" +
                           "userId BIGINT NOT NULL," +
                           "active BIT NOT NULL," +
                           "admin BIT NOT NULL," +
        ...
        runStatement(conn, "CREATE TABLE User_Group (" +
                           "users_userId BIGINT NOT NULL," +
                           "groups_groupId BIGINT NOT NULL" +
                           ");");

        runStatement(conn, "CREATE TABLE _Group (" +
        ...
        runStatement(conn, "CREATE TABLE emPCR (" +
        ...
        runStatement(conn, "CREATE TABLE emPCRDilution (" +
                           "dilutionId BIGINT NOT NULL," +
                           "concentration DOUBLE NOT NULL," +
        ...
        runStatement(conn, "CREATE TABLE Watcher (" +
