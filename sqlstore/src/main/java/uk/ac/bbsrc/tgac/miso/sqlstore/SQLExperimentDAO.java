...
public class SQLExperimentDAO implements ExperimentStore {
    ...
    public static final String EXPERIMENTS_SELECT_BY_SEARCH = EXPERIMENTS_SELECT + " WHERE " +
                                                              "name LIKE ? OR " +
                                                              "alias LIKE ? OR " +
                                                              "description LIKE ? ";
    ...
    public static final String PROFILE_SELECT_BY_EXPERIMENT_ID = "SELECT sp.profileId, sp.allowAllInternal, sp.owner_userId " +
    ...
    */
                ...
                if (namingScheme.validateField("name", experiment.getName())) {
                    ...
                    if (newId.longValue() != experiment.getId()) {
                        ...
                        new NamedParameterJdbcTemplate(template)
                            .update(EXPERIMENT_DELETE, new MapSqlParameterSource().addValue("experimentId", newId.longValue()));
    ...
    public List<Experiment> listBySearch(String query) {
        ...
        return template
            .query(EXPERIMENTS_SELECT_BY_SEARCH, new Object[] { mySQLQuery, mySQLQuery, mySQLQuery }, new ExperimentMapper(true));
    }
