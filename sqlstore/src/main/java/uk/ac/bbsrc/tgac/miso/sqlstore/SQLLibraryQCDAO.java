...
public class SQLLibraryQCDAO implements LibraryQcStore {
    ...
    public static final String LIBRARY_QC = "SELECT qcId, library_libraryId, qcUserName, qcDate, qcMethod, results, insertSize " +
                                            "FROM " + TABLE_NAME;

    public static final String LIBRARY_QC_SELECT_BY_ID = LIBRARY_QC + " WHERE qcId=?";

    public static final String LIBRARY_QC_SELECT_BY_LIBRARY_ID = LIBRARY_QC + " WHERE library_libraryId=? " +
                                                                 "ORDER BY qcDate ASC";
