...
public class SQLLibraryDAO implements LibraryStore {
    ...
    public static final String LIBRARIES_SELECT_BY_SEARCH = LIBRARIES_SELECT + " WHERE " +
...
/*          "SELECT li.* " +
    ...
    public static final String LIBRARY_TYPES_SELECT_BY_PLATFORM = "SELECT libraryTypeId, description, platformType " +
                                                                  "FROM LibraryType " +
                                                                  "WHERE platformType=?";
                    ...
                    if (libraryNamingScheme.validateField("name", library.getName()) &&
                        ...
                        if (newId.longValue() != library.getId()) {
                            ...
                            throw new IOException(
                                "Something bad happened. Expected library ID doesn't match returned value from DB insert");
                        }
                    } else {
