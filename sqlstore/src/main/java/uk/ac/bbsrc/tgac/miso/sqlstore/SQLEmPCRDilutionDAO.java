...
public class SQLEmPCRDilutionDAO implements EmPCRDilutionStore {
    ...
    public Collection<emPCRDilution> listAllEmPcrDilutionsByPlatform(PlatformType platformType) throws IOException {
        return template
            .query(EMPCR_DILUTION_SELECT_BY_LIBRARY_PLATFORM, new Object[] { platformType.getKey() }, new EmPCRDilutionMapper(true));
    }
    ...
    public Collection<emPCRDilution> listAllEmPcrDilutionsByProjectAndPlatform(long projectId, PlatformType platformType)
        throws IOException {
