...
public class UserAuthMisoRequestManager extends MisoRequestManager {
    ...
    public LibraryQC getLibraryQCById(long qcId) throws IOException {
        ...
        if (readCheck(o.getLibrary()))
            ...
            throw new IOException(
                "User " + getCurrentUser().getFullName() + " cannot read parent Library " + o.getLibrary().getId() + " for LibraryQC " +
                qcId);
    }
    ...
    public ProjectOverview getProjectOverviewById(long overviewId) throws IOException {
        ...
        if (readCheck(o.getProject()))
            ...
            throw new IOException(
                "User " + getCurrentUser().getFullName() + " cannot read parent Project " + o.getProject().getProjectId() +
    ...
    public SampleQC getSampleQCById(long sampleQcId) throws IOException {
        ...
        if (readCheck(o.getSample()))
            ...
            throw new IOException(
                "User " + getCurrentUser().getFullName() + " cannot read parent Run " + o.getSample().getId() + " for SampleQC " +
                sampleQcId);
    }
  ...
  /* lists */
    ...
    @Override
    public Collection<Plate<? extends List<? extends Plateable>, ? extends Plateable>> listAllPlatesBySearch(String str)
        throws IOException {
        User user = getCurrentUser();
        Collection<Plate<? extends List<? extends Plateable>, ? extends Plateable>> accessibles = new HashSet<Plate<? extends List<? extends Plateable>, ? extends Plateable>>();
