 ...
 * @since 0.1.6
 */
public class OxfordNanoporeStatus extends StatusImpl {
  String metadata = null;

  public OxfordNanoporeStatus() {
    setHealth(HealthType.Unknown);
  }

  public OxfordNanoporeStatus(String metadata) {
    this.metadata = metadata;
    //parseMetaData(metadata);
  }

  public void parseMetaData(String metadata) {
    //System.out.println("OxfordNanoporeStatus: parsing metadata -> "+metadata);
    /*
    try {
