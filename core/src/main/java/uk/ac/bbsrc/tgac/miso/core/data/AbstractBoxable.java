...
public abstract class AbstractBoxable implements Boxable {
  ...
  public static final int ALIAS_LENGTH = 50;
  public static final int VOLUME_LENGTH = 17;
  @Column(name = "emptied")
  private boolean empty;
  @Column(nullable = true, length=VOLUME_LENGTH)
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(1, 31).append(alias).append(boxAlias).append(boxLocation).append(empty).append(position).append(volume)
        .toHashCode();
  }
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(alias, other.alias).append(boxAlias, other.boxAlias).append(boxLocation, other.boxLocation)
        .append(empty, other.empty).append(position, other.position).append(volume, other.volume).isEquals();
  }
}
